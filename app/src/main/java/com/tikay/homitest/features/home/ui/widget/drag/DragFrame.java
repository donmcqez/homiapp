package com.tikay.homitest.features.home.ui.widget.drag;
...
public class DragFrame extends FrameLayout {
    ...
    protected void onFinishInflate() {
        ...
        edge = HomiApp.self().getPadding();
        bottom = HomiApp.self().getPadding() + heightBottom;
...
//                        timeDown = System.currentTimeMillis();
    ...
    private static int getScaledTouchSlop() {
        if (scaledTouchSlop == 0) {
            scaledTouchSlop = ViewConfiguration.get(HomiApp.self()).getScaledTouchSlop();
        }
